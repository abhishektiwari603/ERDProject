package com.databases.erd.erdtool.keywordChecker;

public class MySQLKeywordChecker
{
	public static enum mysqlKeyword
	{
		...
		NOT , NO_WRITE_TO_BINLOG , NULL , NUMERIC , ON , OPTIMIZE , OPTION , OPTIONALLY , OR , ORDER , OUT ,
		...
		SMALLINT , SONAME , SPATIAL , SPECIFIC , SQL , SQLEXCEPTION , SQLSTATE , SQLWARNING , SQL_BIG_RESULT
	...
	public static boolean check_Keyword(String input)
	{
		boolean var = false;
		for(mysqlKeyword keyword : mysqlKeyword.values())
		{
			if(input.equalsIgnoreCase(keyword.toString()))
			{
				var = true ;
				break;
			}
