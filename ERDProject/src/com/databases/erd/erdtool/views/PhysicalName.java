...
public void fill1(Composite comp1)
	{			
      ...
      //   System.out.println(tab11);
     	 ...
     	 classFigure.setBorder(new LineBorder(ColorConstants.darkBlue,2));
    ...
    viewer.addDoubleClickListener(new IDoubleClickListener() 
    {
		...
		public void doubleClick(DoubleClickEvent event) 
        {
        	try {
        		...
        		int dq=xmltodb.getcolumnindex(xmltodb.getTabName(tabid), subcolname);
        		Iterator<Label> it;
        		it= (Iterator<Label>) classFigure.getMethodsCompartment().getChildren().iterator();
