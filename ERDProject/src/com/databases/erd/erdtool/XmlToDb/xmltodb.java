		...
		try {
			...
			for (int temp = 0; temp < tableList.getLength(); temp++) {
				...
				if (n1.getNodeType() == Node.ELEMENT_NODE) {
					...
					String str = element1.getElementsByTagName("logical_name")
		...
		try {
			...
			for (int i = 0; i < dict.getLength(); i++) {
				...
				if (word.getNodeType() == Node.ELEMENT_NODE) {
					String wordidval = w.getElementsByTagName("id").item(0)
							.getTextContent();
					String columnName = w.getElementsByTagName("logical_name")
							.item(0).getTextContent();
					...
					if (str.equals(s)) {
						...
						for (int i = 0; i < c1; i++) {
							...
							if (n1.getNodeType() == Node.ELEMENT_NODE) {
								...
								column_type.add(element
										.getElementsByTagName("type").item(i)
										.getTextContent());
		...
		try {
			...
			for (int temp = 0; temp < tableList.getLength(); temp++) {
				...
				if (nNode.getNodeType() == Node.ELEMENT_NODE) {
					...
					tables.add(eElement.getElementsByTagName("logical_name")
							.item(0).getTextContent());
				}
			}
		} catch (Exception err) {
					...
					if (str.equals(table_name)) {
						...
						for (int temp1 = 0; temp1 < c; temp1++) {
							if (n2.getNodeType() == Node.ELEMENT_NODE) {
								...
								String s = element2
										.getElementsByTagName("primary_key")
										.item(temp1).getTextContent();

								if (s.equals("true")) {
									primary_key.add(element2
											.getElementsByTagName(
													"logical_name").item(temp1)
											.getTextContent());
								} else {
									continue;
								}
						...
						for (int temp1 = 0; temp1 < c; temp1++) {
							if (n2.getNodeType() == Node.ELEMENT_NODE) {
								Element element2 = (Element) n2;
								String s = element2
										.getElementsByTagName("foreign_key")
										.item(temp1).getTextContent();
								if (s.equals("true")) {
									foreign_key.add(element2
											.getElementsByTagName(
													"logical_name").item(temp1)
											.getTextContent());
								} else {
						...
						for (int temp1 = 0; temp1 < c; temp1++) {
							if (n2.getNodeType() == Node.ELEMENT_NODE) {
								Element element2 = (Element) n2;
								String s = element2
										.getElementsByTagName("unique_key")
										.item(temp1).getTextContent();
								if (s.equals("true")) {
									unique_key.add(element2
											.getElementsByTagName(
													"logical_name").item(temp1)
											.getTextContent());
								} else {
					...
					if (str.equals(table_name)) {
						...
						for (int temp1 = 0; temp1 < c; temp1++) {
							if (n2.getNodeType() == Node.ELEMENT_NODE) {
								...
								String s = element2
										.getElementsByTagName("not_null")
										.item(temp1).getTextContent();

								if (s.equals("true")) {
									null_type.add(element2
											.getElementsByTagName(
													"logical_name").item(temp1)
											.getTextContent());
								} else {
				...
				if (n1.getNodeType() == Node.ELEMENT_NODE) {
					...
					if (str.equals(table)) {
						if (n1.getNodeType() == Node.ELEMENT_NODE) {
							...
							tables.add(element1.getElementsByTagName("x")
									.item(0).getTextContent());
							tables.add(element1.getElementsByTagName("y")
									.item(0).getTextContent());
						}
					}
				}
				...
				if (n1.getNodeType() == Node.ELEMENT_NODE) {
					...
					for (int temp1 = 0; temp1 < c; temp1++) {
						if (n2.getNodeType() == Node.ELEMENT_NODE) {
							...
							String target = element2
									.getElementsByTagName("target").item(temp1)
									.getTextContent();
							String source = element2
									.getElementsByTagName("source").item(temp1)
									.getTextContent();
